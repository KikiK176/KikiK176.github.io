...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		<?php
		if ( get_theme_mod( 'parfum_display_top_bar', 1 ) == 1 ) {

			get_template_part( PARFUM_TEMPLATE_PARTS . 'top-bar' );
			?>
			<div style="position:relative">
				<?php get_template_part( PARFUM_TEMPLATE_PARTS . 'menu-movil' ); ?>
			</div>
			<?php
		}
		?>
		<div class="inner-wrap">
			<div class="header-inner-wrap">
				...
				<div class="main-navigation-wrapper">
					...
					<a class="assistive-text" href="#content" title="<?php esc_attr_e( 'Skip to content', 'parfum' ); ?>"><?php esc_html_e( 'Skip to content', 'parfum' ); ?></a>
					<?php
					wp_nav_menu( array(
		...
		if ( get_theme_mod( 'parfum_display_top_bar', 1 ) == '' ) {
			?>
			<div class="boton-menu-movil-sin-top-bar">
			<i class="fa fa-align-justify"></i> <?php esc_html_e( 'MENU', 'parfum' ); ?>
			</div>
			<div style="position:relative">
				<?php get_template_part( PARFUM_TEMPLATE_PARTS . 'menu-movil' ); ?>
			</div>
